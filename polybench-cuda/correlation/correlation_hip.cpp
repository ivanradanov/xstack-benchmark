...
__global__ void kernel_mean(int m, int n,
                            double *data,
                            double *corr,
                            double mean[],
                            double stddev[]) {
...
__global__ void kernel_stddev(int m, int n,
                              double *data,
                              double *corr,
                              double mean[],
                              double stddev[]) {
...
__global__ void kernel_reduce(int m, int n,
                              double *data,
                              double *corr,
                              double mean[],
                              double stddev[]) {
...
__global__ void kernel_diag(int m, int n,
                            double *data,
                            double *corr,
                            double mean[],
                            double stddev[]) {
...
__global__ void kernel_corr(int m, int n,
                            double *data,
                            double *corr,
                            double mean[],
                            double stddev[]) {
...
__global__ void kernel_tail(int m, int n,
                            double *data,
                            double *corr,
                            double mean[],
                            double stddev[]) {
...
int main(int argc, char** argv)
{
  ...
  double *dev_stddev;
  double *dev_corr;
  hipMalloc(&dev_data, n*m*sizeof(double));
  hipMalloc(&dev_mean, m*sizeof(double));
  hipMalloc(&dev_stddev, m*sizeof(double));
  hipMalloc(&dev_corr, m*m*sizeof(double));
  hipMemcpy(dev_data, data, n*m*sizeof(double), hipMemcpyHostToDevice);
  hipMemcpy(dev_mean, mean, m*sizeof(double), hipMemcpyHostToDevice);
  hipMemcpy(dev_stddev, stddev, m*m*sizeof(double), hipMemcpyHostToDevice);
