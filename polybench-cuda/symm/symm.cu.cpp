...
__global__ void kernel_tmp(int m, int n,
...
__global__ void kernel_C(int m, int n,
                         double alpha, double beta,
                         double *C,
                         double *A,
                         double *B, double *tmp) {
...
__global__ void kernel_sum(int m, int n,
                           double alpha, double beta,
                           double *C,
                           double *A,
                           double *B, double *tmp) {
