...
__global__ void kernel_y(int n,
...
int main(int argc, char** argv)
{
  ...
  hipMalloc(&dev_B, n*n*sizeof(double));
  hipMalloc(&dev_tmp, n*sizeof(double));
  ...
  hipMemcpy(dev_tmp, tmp, n*sizeof(double), hipMemcpyHostToDevice);
