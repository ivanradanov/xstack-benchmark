...
__global__ void kernel_A_mul_B(int ni, int nj, int nk, int nl,
...
int main(int argc, char** argv)
{
  ...
  hipMalloc(&dev_tmp, ni*nj*sizeof(double));
  ...
  hipMemcpy(dev_tmp, tmp, ni*nj*sizeof(double), hipMemcpyHostToDevice);
  ...
  hipMemcpy(D, dev_D, ni*nl*sizeof(double), hipMemcpyDeviceToHost);
  hipFree((void*)dev_A);
  hipFree((void*)dev_B);
  hipFree((void*)dev_C);
  hipFree((void*)dev_D);
  hipFree((void*)dev_tmp);
