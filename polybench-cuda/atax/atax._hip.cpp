...
int main(int argc, char** argv)
{
  ...
  hipMalloc(&dev_x, ny*sizeof(double));
  hipMalloc(&dev_y, ny*sizeof(double));
  hipMalloc(&dev_tmp, nx*sizeof(double));


  hipMemcpy(dev_A, A, nx*ny*sizeof(double), hipMemcpyHostToDevice);
  hipMemcpy(dev_x, x, ny*sizeof(double), hipMemcpyHostToDevice);
  hipMemcpy(dev_y, y, ny*sizeof(double), hipMemcpyHostToDevice);
  hipMemcpy(dev_tmp, tmp, nx*sizeof(double), hipMemcpyHostToDevice);
  ...
  hipMemcpy(y, dev_y, ny*sizeof(double), hipMemcpyDeviceToHost);
