...
__global__ void kernel_A(int n, double alpha, double beta,
                         double *A, double *u1, double *v1, double *u2, double *v2, double *w, double *x, double *y, double *z) {
...
__global__ void kernel_x(int n, double alpha, double beta,
                         double *A, double *u1, double *v1, double *u2, double *v2, double *w, double *x, double *y, double *z) {
  int i = blockDim.x * blockIdx.x + threadIdx.x;
...
__global__ void kernel_y(int n, double alpha, double beta,
                         double *A, double *u1, double *v1, double *u2, double *v2, double *w, double *x, double *y, double *z) {
  int i = blockDim.x * blockIdx.x + threadIdx.x;
...
__global__ void kernel_w(int n, double alpha, double beta,
                         double *A, double *u1, double *v1, double *u2, double *v2, double *w, double *x, double *y, double *z) {
  int i = blockDim.x * blockIdx.x + threadIdx.x;
...
static void kernel(int n, double alpha, double beta,
                   double *A, double *u1, double *v1, double *u2, double *v2, double *w, double *x, double *y, double *z) {
...
int main(int argc, char** argv)
{
  ...
  hipMalloc(&dev_u1, n*sizeof(double));
  hipMalloc(&dev_v1, n*sizeof(double));
  hipMalloc(&dev_u2, n*sizeof(double));
  hipMalloc(&dev_v2, n*sizeof(double));
  hipMalloc(&dev_w, n*sizeof(double));
  hipMalloc(&dev_x, n*sizeof(double));
  hipMalloc(&dev_y, n*sizeof(double));
  hipMalloc(&dev_z, n*sizeof(double));
  ...
  hipMemcpy(dev_u1, u1, n*sizeof(double), hipMemcpyHostToDevice);
  hipMemcpy(dev_v1, v1, n*sizeof(double), hipMemcpyHostToDevice);
  hipMemcpy(dev_u2, u2, n*sizeof(double), hipMemcpyHostToDevice);
  hipMemcpy(dev_v2, v2, n*sizeof(double), hipMemcpyHostToDevice);
  hipMemcpy(dev_w, w, n*sizeof(double), hipMemcpyHostToDevice);
  hipMemcpy(dev_x, x, n*sizeof(double), hipMemcpyHostToDevice);
  hipMemcpy(dev_y, y, n*sizeof(double), hipMemcpyHostToDevice);
  hipMemcpy(dev_z, z, n*sizeof(double), hipMemcpyHostToDevice);
  
  /* Run kernel. */
  kernel(n, alpha, beta, dev_A, dev_u1, dev_v1, dev_u2, dev_v2, dev_w, dev_x, dev_y, dev_z);
  hipMemcpy(w, dev_w, n*sizeof(double), hipMemcpyDeviceToHost);
