...
int main(int argc, char** argv)
{
  ...
  hipMalloc(&dev_x1, n*sizeof(double));
  hipMalloc(&dev_x2, n*sizeof(double));
  hipMalloc(&dev_y_1, n*sizeof(double));
  hipMalloc(&dev_y_2, n*sizeof(double));

  hipMemcpy(dev_A, A, n * n * sizeof(double), hipMemcpyHostToDevice);
  hipMemcpy(dev_x1, x1, n * sizeof(double), hipMemcpyHostToDevice);
  hipMemcpy(dev_x2, x2, n * sizeof(double), hipMemcpyHostToDevice);
